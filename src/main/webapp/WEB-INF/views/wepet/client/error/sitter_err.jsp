...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="/resources/snear/assets/img/favicon/favicon.ico" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="/resources/sneat/assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        <h2 class="mb-2 mx-2">로그인이 필요한 페이지 입니다 :(</h2>
        <p class="mb-4 mx-2"> you need id and password  -- pls login</p>
        <a href="/member/loginform" class="btn btn-primary">Back to loginform</a>
        <div class="mt-3">
          <img
            src="/resources/sneat/assets/img/illustrations/page-misc-error-light.png"
